// lib/features/job/screens/daftar_job_batal_screen.dart
...
class DaftarJobBatalScreen extends StatefulWidget {
  ...
  @override
  State<DaftarJobBatalScreen> createState() => _DaftarJobBatalScreenState();
}

class _DaftarJobBatalScreenState extends State<DaftarJobBatalScreen> {
  ...
  Future<void> _fetchBatalJobs() async {
    setState(() {
      _isLoading = true;
      _errorMessage = null;
    });
    ...
    try {
      ...
      setState(() => _errorMessage = 'Server tidak merespons.');
    } catch (e) {
  ...
  Widget _buildContent() {
    ...
    if (_filteredList.isEmpty) {
      return EmptyStateWidget(
        ...
        message: 'Tidak ada pekerjaan yang dibatalkan.',
        onRetry: _fetchBatalJobs,
      );
    }

    return RefreshIndicator(
      onRefresh: _fetchBatalJobs,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Daftar Job Batal')),
      body: Column(
        children: [
          Padding(
